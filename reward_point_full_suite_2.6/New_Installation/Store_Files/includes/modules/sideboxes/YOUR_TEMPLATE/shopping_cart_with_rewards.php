<?php
/**
 * shopping_cart sidebox - displays contents of customer's shopping cart with reward points.
 *
 ...
 */
  ...
  if ($show_shopping_cart_box == true) {
    require($template->get_template_dir('tpl_shopping_cart_with_rewards.php',DIR_WS_TEMPLATE, $current_page_base,'sideboxes'). '/tpl_shopping_cart_with_rewards.php');
